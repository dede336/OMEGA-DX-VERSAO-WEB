...
const PIECE_META: Record<string, { label: string; icon: string; color: string; image?: any }> = {
  piece_brasao_coragem:      { label: 'Fragmento da Coragem',      icon: 'sun',     color: '#f97316', image: getEquipItemImage('piece_brasao_coragem') },
  piece_brasao_esperanca:    { label: 'Fragmento da Esperança',    icon: 'sun',     color: '#eab308', image: getEquipItemImage('piece_brasao_esperanca') },
  piece_brasao_amizade:      { label: 'Fragmento da Amizade',      icon: 'users',   color: '#3b82f6', image: getEquipItemImage('piece_brasao_amizade') },
  piece_brasao_confianca:    { label: 'Fragmento da Confiança',    icon: 'shield',  color: '#94a3b8', image: getEquipItemImage('piece_brasao_confianca') },
  piece_brasao_pureza:       { label: 'Fragmento da Pureza',       icon: 'droplet', color: '#22c55e', image: getEquipItemImage('piece_brasao_pureza') },
  piece_brasao_amor:         { label: 'Fragmento do Amor',         icon: 'heart',   color: '#f43f5e', image: getEquipItemImage('piece_brasao_amor') },
  piece_brasao_luz:          { label: 'Fragmento da Luz',          icon: 'star',    color: '#c084fc', image: getEquipItemImage('piece_brasao_luz') },
  piece_brasao_conhecimento: { label: 'Fragmento do Conhecimento', icon: 'book',    color: '#a855f7', image: getEquipItemImage('piece_brasao_conhecimento') },
  piece_brasao_bondade:      { label: 'Fragmento da Bondade',      icon: 'heart',   color: '#d946ef', image: getEquipItemImage('piece_brasao_bondade') },
  piece_brasao_milagre:      { label: 'Fragmento do Milagre',      icon: 'star',    color: '#facc15' , image: getEquipItemImage('piece_brasao_milagre') },
  piece_brasao_destino:      { label: 'Fragmento do Destino',      icon: 'compass', color: '#a78bfa' , image: getEquipItemImage('piece_brasao_destino') },
