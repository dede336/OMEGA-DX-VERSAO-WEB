  ...
  return <Modal visible={visible} transparent={false} animationType="fade" onRequestClose={onClose}>
    <View style={styles.screen}>
      ...
      <View style={styles.stage}>
        ...
        <Animated.View style={[styles.silhouette, { opacity: silhouettes, transform: [{ translateX: right }] }]}><Image source={image} style={[styles.sprite, whiteStyle]} resizeMode="contain" /></Animated.View>
