...
export default function NavigationFAB() {
  ...
  const canShowAdmin =
    (user?.isAdmin ?? isAdmin) || user?.role === 'digimon_creator';
...
const styles = StyleSheet.create({
  ...
  // WEB:
  // prende o botão MENU dentro da área do jogo,
  // sem usar a largura total da janela do navegador
  fabWrapperWeb: {
    position: 'absolute',
    right: EDGE_GAP,
    bottom: 24,
