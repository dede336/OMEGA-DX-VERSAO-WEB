...
const EQUIP_ITEM_IMAGES: Record<string, any> = {
  ...
  piece_brasao_coragem:      require('../assets/images/brasao_coragem.webp'),
  piece_brasao_esperanca:    require('../assets/images/brasao_esperanca_v4.webp'),
  piece_brasao_amizade:      require('../assets/images/brasao_amizade.webp'),
  piece_brasao_confianca:    require('../assets/images/brasao_confianca.webp'),
  piece_brasao_pureza:       require('../assets/images/brasao_pureza.webp'),
  piece_brasao_amor:         require('../assets/images/brasao_amor.webp'),
  piece_brasao_luz:          require('../assets/images/brasao_luz.webp'),
  piece_brasao_conhecimento: require('../assets/images/brasao_conhecimento.webp'),
  piece_brasao_bondade:      require('../assets/images/brasao_bondade.png'),
